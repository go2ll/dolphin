...
public class Leave {
	...
	public String toString() {
		return "Leave [applierId=" + applierId + ", leaveDayNum=" + leaveDayNum + ", approverId=" + approverId + ", reason=" + reason
				+ ", processInsId=" + processInsId + ", approveFlag=" + approveFlag + ", applyDate=" + applyDate + "]";
	}
