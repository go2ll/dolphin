...
public final class DolphinJTAProxy {	
	...
	private static final Callback[] CALLBACK_FILTERS = new Callback[] { JTA_TXN_INTERCEPTOR, NoOp.INSTANCE };
	...
	public static <T> T getProxy(Class<T> type) {
		T obj = type.cast(Enhancer.create(type, type.getInterfaces(), JTA_TXN_FILTER, CALLBACK_FILTERS));
		return obj;
	}
	...
	private static final class JtaTxnInterceptor implements MethodInterceptor {
		...
		public Object intercept(Object obj, Method m, Object[] args, MethodProxy proxy) throws Throwable {
			UserTransaction transaction = JndiIntegration.fromJndi(UserTransaction.class, "java:comp/UserTransaction");
			Object ret = null;
