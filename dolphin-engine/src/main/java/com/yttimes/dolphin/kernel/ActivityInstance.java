...
public abstract class ActivityInstance implements Comparable<ActivityInstance>{
	...
	public void cancel() {
		if (getState() == State.SUSPENDED || getState() == State.RUNNING) {
			...
			throw new DolphinException("Activity " + getActivityId() + " is not ready to be canceld, state="+getState());
		}
	}
	...
	public String toString() {
		return "ActivityInstance [id=" + getId() + ", actId="+getActivityId()+", type=" + getType() +  ", state=" + state + "]";
	}
}
