/**
 * $Header: /home/cvsroot/dolphin/LeaveProcessDemo/src/main/java/com/yttimes/dolphin/example/assignment/DeptManagerAssignment.java,v 1.2.2.2 2011/09/23 02:39:01 neo-cvs Exp $
 * $Revision: 1.2.2.2 $
...
/**
 * @author Ivan Li
 * @version $Id: DeptManagerAssignment.java,v 1.2.2.2 2011/09/23 02:39:01 neo-cvs Exp $
 */
public class DeptManagerAssignment implements AssignmentHandler {

  @Override
  public long[] findUserIds(TaskInstance taskInstance) {
    return UserService.getDeptManager();
  }
